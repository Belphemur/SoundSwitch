...
namespace MP3Sharp.Decoding {
    ...
    internal sealed class Huffman {
        ...
        internal static void Initialize() {
            ...
            Huffman[] table = new Huffman[HTN];
            table[0] = new Huffman("0  ", 0, 0, 0, 0, -1, null, null, ValTab0, 0);
            table[1] = new Huffman("1  ", 2, 2, 0, 0, -1, null, null, ValTab1, 7);
            table[2] = new Huffman("2  ", 3, 3, 0, 0, -1, null, null, ValTab2, 17);
            table[3] = new Huffman("3  ", 3, 3, 0, 0, -1, null, null, ValTab3, 17);
            table[4] = new Huffman("4  ", 0, 0, 0, 0, -1, null, null, ValTab4, 0);
            table[5] = new Huffman("5  ", 4, 4, 0, 0, -1, null, null, ValTab5, 31);
            table[6] = new Huffman("6  ", 4, 4, 0, 0, -1, null, null, ValTab6, 31);
            table[7] = new Huffman("7  ", 6, 6, 0, 0, -1, null, null, ValTab7, 71);
            table[8] = new Huffman("8  ", 6, 6, 0, 0, -1, null, null, ValTab8, 71);
            table[9] = new Huffman("9  ", 6, 6, 0, 0, -1, null, null, ValTab9, 71);
            table[10] = new Huffman("10 ", 8, 8, 0, 0, -1, null, null, ValTab10, 127);
            table[11] = new Huffman("11 ", 8, 8, 0, 0, -1, null, null, ValTab11, 127);
            table[12] = new Huffman("12 ", 8, 8, 0, 0, -1, null, null, ValTab12, 127);
            table[13] = new Huffman("13 ", 16, 16, 0, 0, -1, null, null, ValTab13, 511);
            table[14] = new Huffman("14 ", 0, 0, 0, 0, -1, null, null, ValTab14, 0);
            table[15] = new Huffman("15 ", 16, 16, 0, 0, -1, null, null, ValTab15, 511);
            table[16] = new Huffman("16 ", 16, 16, 1, 1, -1, null, null, ValTab16, 511);
            table[17] = new Huffman("17 ", 16, 16, 2, 3, 16, null, null, ValTab16, 511);
            table[18] = new Huffman("18 ", 16, 16, 3, 7, 16, null, null, ValTab16, 511);
            table[19] = new Huffman("19 ", 16, 16, 4, 15, 16, null, null, ValTab16, 511);
            table[20] = new Huffman("20 ", 16, 16, 6, 63, 16, null, null, ValTab16, 511);
            table[21] = new Huffman("21 ", 16, 16, 8, 255, 16, null, null, ValTab16, 511);
            table[22] = new Huffman("22 ", 16, 16, 10, 1023, 16, null, null, ValTab16, 511);
            table[23] = new Huffman("23 ", 16, 16, 13, 8191, 16, null, null, ValTab16, 511);
            table[24] = new Huffman("24 ", 16, 16, 4, 15, -1, null, null, ValTab24, 512);
            table[25] = new Huffman("25 ", 16, 16, 5, 31, 24, null, null, ValTab24, 512);
            table[26] = new Huffman("26 ", 16, 16, 6, 63, 24, null, null, ValTab24, 512);
            table[27] = new Huffman("27 ", 16, 16, 7, 127, 24, null, null, ValTab24, 512);
            table[28] = new Huffman("28 ", 16, 16, 8, 255, 24, null, null, ValTab24, 512);
            table[29] = new Huffman("29 ", 16, 16, 9, 511, 24, null, null, ValTab24, 512);
            table[30] = new Huffman("30 ", 16, 16, 11, 2047, 24, null, null, ValTab24, 512);
            table[31] = new Huffman("31 ", 16, 16, 13, 8191, 24, null, null, ValTab24, 512);
            table[32] = new Huffman("32 ", 1, 16, 0, 0, -1, null, null, ValTab32, 31);
            table[33] = new Huffman("33 ", 1, 16, 0, 0, -1, null, null, ValTab33, 31);
            HuffmanTable = table;
        }
    }
}