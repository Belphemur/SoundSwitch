...
pt_br.AddCertDescription=Confiar nos certificados do {#MyAppSetupName}%nDesde modo não receberá alerta quando o {#MyAppSetupName} atualizar.
...
pt_br.UninstallQuestion=Deseja apagar as configurações do {#MyAppSetupName}?
