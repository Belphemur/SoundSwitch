...
#if DotNetMajorVersion == "10"
  Log('Removing .NET 10 Desktop Runtime versions older than 10.0.11 for architecture "' + Dependency_ArchTitle + '".');
  UninstallOlderDotNetRuntimes(10, 0, 11, Dependency_ArchTitle);
#elif DotNetMajorVersion == "9"
