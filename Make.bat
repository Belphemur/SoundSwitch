...
for %%R in (win-x64 win-arm64) do (
    ...
    xcopy /y /e %finalDir%\SoundSwitch.CLI-publish-%%R\* %finalDir%\%%R\ >nul 2>nul
    rmdir /q /s %finalDir%\SoundSwitch.CLI-publish-%%R >nul 2>nul
    ...
    xcopy /y /e %finalDir%\SoundSwitch-publish-%%R\* %finalDir%\%%R\ >nul 2>nul
    rmdir /q /s %finalDir%\SoundSwitch-publish-%%R >nul 2>nul
)
