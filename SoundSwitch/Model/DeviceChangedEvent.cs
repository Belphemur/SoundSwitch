...
public record DefaultDeviceChangedEvent(EventType Action, string DeviceId, ERole Role) : DeviceChangedEvent(Action, DeviceId), IComparable<DefaultDeviceChangedEvent>
{
