...
## I can't see the icon at all

Windows hides new tray icons by default to keep the system tray clean. You need to drag the SoundSwitch icon out of the overflow area onto the visible portion of the tray.

![Showing the tray icon](/images/faq/tray-icon-visibility.gif)

Click the small **^** (chevron) on the taskbar to reveal hidden icons, then drag SoundSwitch into the always-visible area.

---

_Sources: [#850](https://github.com/Belphemur/SoundSwitch/discussions/850), [#982](https://github.com/Belphemur/SoundSwitch/discussions/982)_
